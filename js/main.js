...
(function() {
	...
	function initEvents() {
		...
		window.addEventListener('mousemove', throttle(function(ev) {
			...
			imghero.style.WebkitTransform = 'perspective(500px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
			imghero.style.transform = 'perspective(500px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
		}, 0));
